...
#SBATCH --mem=32G
#SBATCH --time=1:30:00
#SBATCH --output=/scratch/mhq8ka/aasist/logs/v3_la_eval_%j.out
#SBATCH --error=/scratch/mhq8ka/aasist/logs/v3_la_eval_%j.err
...
OUT="/scratch/$USER/aasist/outputs/eval/${V3_RUN_NAME}_2021_LA_eval"
