...
#SBATCH --mem=32G
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/mhq8ka/aasist/logs/v2_df_eval_%j.out
#SBATCH --error=/scratch/mhq8ka/aasist/logs/v2_df_eval_%j.err
...
OUT="/scratch/$USER/aasist/outputs/eval/v2_2021_DF_eval"
