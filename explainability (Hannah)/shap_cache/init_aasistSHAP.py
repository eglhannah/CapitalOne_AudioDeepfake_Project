...
protocols = parse_protocols_LADEV(Path(r"I:\My Drive\ASVSpoof_Data\unzipped2019\LA\LA\ASVspoof2019_LA_cm_protocols\ASVspoof2019.LA.cm.dev.trl.txt"))
...
aasist_wrapper = AASISTWrapper(model).to(DEVICE)
aasist_wrapper.eval()
